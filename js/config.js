...
export const HOUSES_JSON_URL = 'https://raw.githubusercontent.com/omerel/achi-eilat-street-map/main/houses.json';
export const WORKER_URL = 'https://achi-eilat-street-map-worker.achi-eilat-street-map-worker.workers.dev/update-house';
